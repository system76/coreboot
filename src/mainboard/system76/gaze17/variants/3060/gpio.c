...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_NF(GPP_D7, NONE, DEEP, NF1), // WLAN_CKLREQ#
	...
	PAD_NC(GPP_F9, NONE),
	PAD_CFG_GPO(GPP_F10, 0, DEEP), // CARD_RTD3_RST#
	PAD_NC(GPP_F11, NONE),
	PAD_CFG_GPI(GPP_F12, NONE, PLTRST), // GPIO4_GC6_NVVDD_EN
	PAD_CFG_GPI(GPP_F13, NONE, PLTRST), // GC6_GB_EN_PCH
	PAD_NC(GPP_F14, NONE),
	PAD_NC(GPP_F15, NONE),
	...
	/* ------- GPIO Group GPP_H ------- */
	PAD_CFG_GPO(GPP_H0, 0, DEEP), // M2_PCH_SSD_RST#
	PAD_CFG_GPO(GPP_H1, 0, DEEP), // Strap 22 of 24
	PAD_CFG_GPO(GPP_H2, 0, DEEP), // M2_WLAN_RST#
