...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A0, UP_20K, DEEP, NF1), // ESPI_IO_0
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A1, UP_20K, DEEP, NF1), // ESPI_IO_1
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A2, UP_20K, DEEP, NF1), // ESPI_IO_2
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A3, UP_20K, DEEP, NF1), // ESPI_IO_3
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A4, UP_20K, DEEP, NF1), // ESPI_CS_N
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A5, DN_20K, DEEP, NF1), // ESPI_CLK
