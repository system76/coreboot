...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_TERM_GPO(GPD7, 1, NONE, PWROK), // GPD7_REST
	PAD_CFG_NF(GPD8, NONE, PWROK, NF1), // SUS_CLK
	PAD_CFG_TERM_GPO(GPD9, 0, NONE, PWROK), // GPD9_RTD3
	...
	PAD_CFG_TERM_GPO(GPP_A13, 1, NONE, PLTRST), // PCH_BT_EN
	PAD_NC(GPP_A14, NONE),
	PAD_NC(GPP_A15, NONE),
	...
	PAD_NC(GPP_A21, NONE),
	PAD_NC(GPP_A22, NONE),
	PAD_CFG_TERM_GPO(GPP_A23, 0, NONE, PLTRST), // GPPC_A23_TBT_FORCE_PWR
	...
	PAD_NC(GPP_B7, NONE),
	PAD_CFG_TERM_GPO(GPP_B8, 1, NONE, DEEP), // SB_BLON
	PAD_NC(GPP_B9, NONE),
	PAD_NC(GPP_B10, NONE),
	PAD_CFG_NF(GPP_B11, NONE, PWROK, NF1), // TBTA-PCH_I2C_INT
	PAD_CFG_NF(GPP_B12, NONE, DEEP, NF1), // SLP_S0#
	PAD_CFG_NF(GPP_B13, NONE, DEEP, NF1), // PLT_RST#
	PAD_CFG_TERM_GPO(GPP_B14, 0, NONE, DEEP), // PCH_SPKR
	PAD_CFG_TERM_GPO(GPP_B15, 1, NONE, DEEP), // PCH_GPP_B15 - TODO
	PAD_NC(GPP_B16, NONE),
	PAD_NC(GPP_B17, NONE),
	...
	PAD_CFG_TERM_GPO(GPP_B23, 0, NONE, DEEP), // Clock frequency strap
	...
	PAD_CFG_TERM_GPO(GPP_D13, 0, NONE, DEEP), // dGPU_OVRM
	PAD_CFG_TERM_GPO(GPP_D14, 1, NONE, PLTRST), // SSD1_PWR_DN#
	PAD_NC(GPP_D15, NONE),
	PAD_NC(GPP_D16, NONE),
	...
	PAD_CFG_TERM_GPO(GPP_E1, 0, NONE, PLTRST), // ROM_I2C_EN
	...
	PAD_NC(GPP_E17, NONE),
	PAD_NC(GPP_E18, NONE), // GPP_E18_TBT_LSX0_TXD - programmed by FSP, see Intel document 617016
	PAD_NC(GPP_E19, NONE), // GPP_E19_TBT_LSX0_RXD - programmed by FSP, see Intel document 617016
	PAD_NC(GPP_E20, NONE),
	PAD_NC(GPP_E21, NONE),
	PAD_NC(GPP_E22, NONE),
	PAD_NC(GPP_E23, NONE),
	...
	PAD_CFG_TERM_GPO(GPP_F7, 1, NONE, DEEP), // GPIO_LANRTD3
	PAD_NC(GPP_F8, NONE),
	PAD_CFG_TERM_GPO(GPP_F9, 1, NONE, DEEP), // GPIO_LAN_EN
	...
	PAD_CFG_TERM_GPO(GPP_H0, 1, NONE, PLTRST), // GPP_H0_RTD3
	...
	//PAD_CFG_GPO(GPP_U4, 0, DEEP), // DGPU_RST#_PCH - handled in bootblock.c
	//PAD_CFG_GPO(GPP_U5, 0, DEEP), // DGPU_PWR_EN - handled in bootblock.c
};
