...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_GPI(GPP_C03, NONE, PLTRST), // SML0CLK
	PAD_CFG_GPI(GPP_C04, NONE, PLTRST), // SML0DATA
	PAD_CFG_NF(GPP_C05, UP_20K, PLTRST, NF1),
	PAD_CFG_NF(GPP_C06, UP_20K, PLTRST, NF1), // SML1CLK
	PAD_CFG_NF(GPP_C07, UP_20K, PLTRST, NF1), // SML1DATA
	PAD_CFG_NF(GPP_C08, NONE, PLTRST, NF1),
	PAD_CFG_NF(GPP_C09, NONE, PLTRST, NF1),
	PAD_CFG_GPI(GPP_C10, NONE, PLTRST), // SRCCLKREQ1#
	PAD_CFG_NF(GPP_C11, NONE, PLTRST, NF1), // SRCCLKREQ2#
	PAD_CFG_NF(GPP_C12, NONE, PLTRST, NF1), // SRCCLKREQ3#
	PAD_CFG_GPI(GPP_C13, NONE, PLTRST),
	PAD_NC(GPP_C14, NONE),
	PAD_CFG_NF(GPP_C15, NONE, DEEP, NF1),
	// PAD_CFG_NF(GPP_C16, NONE, DEEP, NF1), configured by FSP
	// PAD_CFG_NF(GPP_C17, NONE, DEEP, NF1), configured by FSP
	PAD_NC(GPP_C18, NONE),
	PAD_NC(GPP_C19, NONE),
