...
static const struct pad_config gpio_table[] = {
	...
	/* ------- GPIO Group GPP_E ------- */
	PAD_CFG_GPO(GPP_E0, 1, DEEP), // NC (old), GPP_F16_TBT_RST# (new)
	...
	_PAD_CFG_STRUCT(GPP_E19, 0x42880100, 0x0000), // NC (old), GPP_F9_TBT_WAKE# (new)
	...
	PAD_CFG_GPO(GPP_F5, 1, PLTRST), // GPP_F5_TBT_RTD3 (old), NC (new)
	PAD_CFG_GPO(GPP_F6, 0, DEEP),
	PAD_CFG_GPO(GPP_F7, 0, DEEP),
	PAD_CFG_GPI(GPP_F8, NONE, DEEP), // GC6_FB_EN_PCH
	_PAD_CFG_STRUCT(GPP_F9, 0x42880100, 0x0000), // GPP_F9_TBT_WAKE# (old), NC (new)
	...
	PAD_CFG_GPO(GPP_F16, 1, DEEP), // GPP_F16_TBT_RST# (old), NC (new)
	...
	_PAD_CFG_STRUCT(GPP_G7, 0x42800100, 0x0000), // TBCIO_PLUG_EVENT# (old), NC (new)
	...
	PAD_CFG_GPO(GPP_R7, 1, PLTRST), // NC (old), GPP_R7_TBT_RTD3 (new)
