...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_GPO(GPD2, 0, DEEP), // LAN_WAKE#
	...
	PAD_NC(GPP_B21, NONE),
	PAD_NC(GPP_B22, NONE),
	PAD_CFG_GPI(GPP_B23, NONE, DEEP), // Xtal freq strap
	...
	PAD_CFG_GPO(GPP_C5, 0, DEEP), // eSPI disable strap
	...
	PAD_NC(GPP_D4, NONE),
	PAD_CFG_GPO(GPP_D5, 0, DEEP), // M.2_BT_PCMFRM_CRF_RST_N
	PAD_CFG_GPO(GPP_D6, 0, DEEP), // M.2_BT_PCMOUT_CLKREQ0
	PAD_NC(GPP_D7, NONE),
	PAD_NC(GPP_D8, NONE),
	PAD_NC(GPP_D9, NONE),
	PAD_NC(GPP_D10, NONE),
	PAD_NC(GPP_D11, NONE),
	PAD_CFG_NF(GPP_D12, NATIVE, DEEP, NF1), // SSD2_CLKREQ#
	PAD_NC(GPP_D13, NONE),
	PAD_NC(GPP_D14, NONE),
	PAD_NC(GPP_D15, NONE),
	PAD_NC(GPP_D16, NONE),
	...
	/* ------- GPIO Group GPP_F ------- */
	PAD_CFG_NF(GPP_F0, NONE, DEEP, NF2), // M.2_SSD_SATA_DET_N
	PAD_NC(GPP_F1, NONE),
	PAD_NC(GPP_F2, NONE),
	PAD_NC(GPP_F3, NONE),
	PAD_NC(GPP_F4, NONE),
	...
	/* ------- GPIO Group GPP_I ------- */
	PAD_NC(GPP_I0, NONE),
	PAD_CFG_NF(GPP_I1, NONE, PLTRST, NF1), // DP_HPD
	...
	PAD_CFG_NF(GPP_I13, NONE, DEEP, NF2), // USB_OC6#
	PAD_CFG_NF(GPP_I14, NONE, DEEP, NF2), // USB_OC7#
	PAD_NC(GPP_I15, NONE),
	PAD_NC(GPP_I16, NONE),
	PAD_NC(GPP_I17, NONE),
