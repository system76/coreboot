...
static const struct pad_config gpio_table[] = {
	/* ------- GPIO Group GPD ------- */
	PAD_NC(GPD0, NONE), // PM_BATLOW# // XXX
	...
	PAD_NC(GPD9, NONE), // GPD9_RTD3 on galp3-c, NC on darp5 // XXX
	PAD_NC(GPD10, NONE), // T28 on galp3-c, T21 on darp5
	PAD_NC(GPD11, NONE),
	...
	PAD_NC(GPP_A7, NONE), // TPM_PIRQ# // XXX
	...
	PAD_NC(GPP_B16, NONE),
	PAD_NC(GPP_B17, NONE),
	PAD_NC(GPP_B18, NONE), // T16 on galp3-c, NO REBOOT STRAP on darp5 // XXX
	PAD_NC(GPP_B19, NONE),
	PAD_NC(GPP_B20, NONE),
	PAD_NC(GPP_B21, NONE),
	...
	PAD_NC(GPP_C3, NONE),
	PAD_NC(GPP_C4, NONE),
	PAD_NC(GPP_C5, NONE), // 4.7k pull down on galp3-c, WLAK_WAKEUP# on darp5 // XXX
	PAD_NC(GPP_C6, NONE), // LAN_WAKEUP# on galp3-c, NC on darp5 // XXX
	PAD_NC(GPP_C7, NONE),
	PAD_NC(GPP_C8, NONE),
	...
	PAD_NC(GPP_C18, NONE),
	PAD_NC(GPP_C19, NONE), // SWI# on galp3-c, NC on darp5 // XXX
	//PAD_CFG_NF(GPP_C20, NONE, DEEP, NF1), // UART2_RXD
	//PAD_CFG_NF(GPP_C21, NONE, DEEP, NF1), // UART2_TXD
	PAD_NC(GPP_C22, NONE),
	PAD_CFG_GPI_APIC(GPP_C23, NONE, PLTRST, EDGE_SINGLE, INVERT), // NC on galp3-c, TP_ATTN# on darp5 // XXX
	...
	PAD_NC(GPP_D12, NONE), // 100k pull up on galp3-c, NC on darp5 // XXX
	PAD_NC(GPP_D13, NONE),
	PAD_NC(GPP_D14, NONE),
	PAD_NC(GPP_D15, NONE), // NC on galp3-c and darp5, TBT_RTD3_PWR_EN_R on galp4 // XXX
	...
	PAD_NC(GPP_D21, NONE), // TPM_DET# // XXX
	PAD_NC(GPP_D22, NONE), // TPM_TCM_Detect // XXX
	PAD_NC(GPP_D23, NONE),
	...
	/* ------- GPIO Group GPP_G ------- */
	PAD_NC(GPP_G0, NONE), // EDP_DET on galp3-c, NC on darp5 // XXX
	PAD_NC(GPP_G1, NONE),
	PAD_NC(GPP_G2, NONE),
	PAD_NC(GPP_G3, NONE), // ASM1543_I_SEL0 on galp3-c, NC on darp5 // XXX
	PAD_NC(GPP_G4, NONE), // ASM1543_I_SEL1 on galp3-c, NC on darp5 // XXX
	PAD_NC(GPP_G5, NONE), // BOARD_ID // XXX
	PAD_NC(GPP_G6, NONE),
	PAD_NC(GPP_G7, NONE), // TBT_Detect // XXX
	...
	PAD_NC(GPP_H19, NONE),
	PAD_NC(GPP_H20, NONE),
	PAD_NC(GPP_H21, NONE), // GPPC_H21; LOW: 38.4/19.2M, HI: 24M
	PAD_NC(GPP_H22, NONE), // TBT_RTD3_PWR_EN_R
	PAD_NC(GPP_H23, NONE), // WIGIG_PEWAKE on galp3-c, NC on darp5 // XXX
};
