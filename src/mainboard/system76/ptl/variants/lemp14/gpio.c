...
static const struct pad_config gpio_table[] = {
	...
	PAD_NC(GPP_A09, NONE),
	PAD_NC(GPP_A10, NONE),
	PAD_CFG_NF(GPP_A11, NONE, DEEP, NF1), // WLAN_RST#
	PAD_NC(GPP_A12, NONE), // WLAN_WAKEUP#
	...
	PAD_NC(GPP_B18, NONE),
	PAD_NC(GPP_B19, NONE),
	PAD_CFG_GPO(GPP_B20, 1, DEEP), // LTE_RST_N
	...
	//PAD_NC(GPP_E04, NONE),
	PAD_NC(GPP_E05, NONE),
	PAD_CFG_GPO(GPP_E06, 1, PLTRST), // JTAG ODT strap
	PAD_NC(GPP_E07, NONE),
	...
	PAD_CFG_GPO(GPP_H00, 0, RSMRST), // MAFS strap
	...
	PAD_NC(GPP_S00, NONE),
	PAD_NC(GPP_S01, NONE),
	PAD_NC(GPP_S02, NONE), // DMIC_CLK
	PAD_NC(GPP_S03, NONE), // DMIC_DATA
	PAD_NC(GPP_S04, NONE), // BT_PCMCLK
	PAD_NC(GPP_S05, NONE), // BT_PCMFRM
	PAD_NC(GPP_S06, NONE), // BT_PCMOUT
	PAD_NC(GPP_S07, NONE), // BT_PCMIN
