...
static const struct pad_config gpio_table[] = {
	...
	/* ------- GPIO Group GPP_A ------- */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A0, UP_20K, DEEP, NF1), // ESPI_AD0
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A1, UP_20K, DEEP, NF1), // ESPI_AD1
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A2, UP_20K, DEEP, NF1), // ESPI_AD2
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A3, UP_20K, DEEP, NF1), // ESPI_AD3
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A4, UP_20K, DEEP, NF1), // ESPI_FRAME#
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_A5, DN_20K, DEEP, NF1), // ESPI_KBC
