...
#ifndef _SOC_NOVALAKE_PCI_DEVS_H_
#define _SOC_NOVALAKE_PCI_DEVS_H_
...
#define  PCI_DEVFN_PCIE13	_PCI_DEVFN(PCIE_2, 4)
#define  PCI_DEVFN_PCIE14	_PCI_DEVFN(PCIE_2, 5)
...
#define  PCI_DEV_PCIE13		_PCI_DEV(PCIE_2, 4)
#define  PCI_DEV_PCIE14		_PCI_DEV(PCIE_2, 5)

#define PCI_DEV_SLOT_TBT	0x07
#define PCI_DEVFN_TBT(x)	_PCI_DEVFN(TBT, (x))
#define NUM_TBT_FUNCTIONS	3
...
#define PCI_DEV_SLOT_THC1	0x08
#define  PCI_DEVFN_THC1		_PCI_DEVFN(THC1, 0)
#define  PCI_DEV_THC1		_PCI_DEV(THC1, 0)
...
#define NUM_TCSS_DMA_FUNCTIONS	1
...
#define PCI_DEV_SLOT_THC0	0x10
#define  PCI_DEVFN_THC0		_PCI_DEVFN(THC0, 0)
#define  PCI_DEV_THC0		_PCI_DEV(THC0, 0)
...
#define PCI_DEV_SLOT_IEH1	0x12
#define  PCI_DEVFN_IEH1		_PCI_DEVFN(IEH1, 0)
#define  PCI_DEVFN_P2SB2	_PCI_DEVFN(IEH1, 1)
#define  PCI_DEVFN_GSPI2	_PCI_DEVFN(IEH1, 6)
#define  PCI_DEV_IEH1		_PCI_DEV(IEH1, 0)
#define  PCI_DEV_P2SB2		_PCI_DEV(IEH1, 1)
#define  PCI_DEV_GSPI2		_PCI_DEV(IEH1, 6)

#define PCI_DEV_SLOT_OSSE	0x13
#define  PCI_DEVFN_OSSE1	_PCI_DEVFN(OSSE, 0)
#define  PCI_DEVFN_OSSE2	_PCI_DEVFN(OSSE, 1)
#define  PCI_DEVFN_OSSE3	_PCI_DEVFN(OSSE, 2)
#define  PCI_DEV_OSSE1		_PCI_DEV(OSSE, 0)
#define  PCI_DEV_OSSE2		_PCI_DEV(OSSE, 1)
#define  PCI_DEV_OSSE3		_PCI_DEV(OSSE, 2)
...
#define  PCI_DEVFN_IEH		_PCI_DEVFN(XHCI, 5)
...
#define  PCI_DEV_IEH		_PCI_DEV(XHCI, 5)
...
#define  PCI_DEV_CSE_WLAN	_PCI_DEV(CSE, 7)
...
/* for common code */
#define MIN_PCH_SLOT		PCI_DEV_SLOT_THC0
...
#define PCH_DEV_P2SB2		PCI_DEV_P2SB2
...
#define PCI_DEV_IOE_P2SB	PCH_DEV_P2SB2
...
#endif /* _SOC_NOVALAKE_PCI_DEVS_H_ */
