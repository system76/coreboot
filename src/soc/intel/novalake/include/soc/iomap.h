...
#ifndef _SOC_NOVALAKE_IOMAP_H_
#define _SOC_NOVALAKE_IOMAP_H_
...
#define MCH_BASE_ADDRESS	0x4152000000
#define MCH_BASE_SIZE		0x40000

#define NOHOM_BASE_ADDRESS	0x4140000000

#define NOHOM_LIMIT_ADDRESS	0x4180000000
#define NOHOM_SIZE		0x40000000

/* System Agent Fabric (SAF) */
#define SAF_BASE_ADDRESS	0x4150000000
#define SAF_BASE_SIZE		(32 * MiB)
...
/* REGBAR 128MB */
#define REG_BASE_ADDRESS	0x4148000000
...
#define IOM_BASE_ADDR		0x4110800000 /* P2SB2_BAR + (PID_IOM << 16) */
#define IOM_BASE_SIZE		0x10000
#define IOM_BASE_ADDR_MAX	0x411080ffff /* IOM_BASE_ADDR + IOM_BASE_SIZE - 1 */

/* Temporary MMIO address for GMADR (aka LMEMBAR) with 256MB */
#define GMADR_BASE		0x4180000000
